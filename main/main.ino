...
#define RIGHT_ENC_PIN_0                2
#define RIGHT_ENC_PIN_1                3
...
void setup() {
  ...
  // Motors motors(LEFT_ENC_PIN_0, LEFT_ENC_PIN_1, RIGHT_ENC_PIN_0, RIGHT_ENC_PIN_1);
...
void loop() {
  ...
  Serial.print(" Z: ");
  Serial.println(accelerometer->getZ1());
}
